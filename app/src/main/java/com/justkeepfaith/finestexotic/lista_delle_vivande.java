        ...
        Morelgtbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!Conectivity.isConnectingToInternet(lista_delle_vivande.this)) {
                    Toast.makeText(lista_delle_vivande.this, "Per favore controlla la tua connessione Internet", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                Toast.makeText(lista_delle_vivande.this, "Disconnesso", Toast.LENGTH_SHORT).show();
