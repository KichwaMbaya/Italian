            ...
            public void onClick(View view) {
                ...
                if (Build.VERSION.SDK_INT >= 33) {
                    ...
                    if (ContextCompat.checkSelfPermission(applicato_successo.this,
                        ...
                        dialog.setMessage("Si prega di consentire le notifiche per questa app per essere avvisati " +
                                "quando il prestito è pronto");
                        dialog.setPositiveButton("VA BENE", new DialogInterface.OnClickListener() {
                            @Override
