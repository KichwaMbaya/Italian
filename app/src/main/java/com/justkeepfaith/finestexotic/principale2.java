...
public class principale2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hmwelcome.setText("Benvenuta " + lname );
        upcloan.setText("€ " + applied + ",00");
        limittxt.setText("€ " + limit + ",00");
        hmbalance.setText("Bilancia: €" + balance );
        ...
        if (!Conectivity.isConnectingToInternet(principale2.this)) {
            Toast.makeText(principale2.this, "Per favore controlla la tua connessione Internet", Toast.LENGTH_SHORT).show();
        }
